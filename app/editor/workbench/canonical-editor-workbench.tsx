...
export function CanonicalEditorWorkbench() {
  ...
  const interactions = useCanvasInteractions({ svgRef: viewport.canvasRef, state: editor.state, dispatch: editor.dispatch, makeId });
        ...
        <div style={{ position: "relative", width: viewport.layout.surfaceWidth, height: viewport.layout.surfaceHeight }}>
          <div style={{ position: "absolute", left: viewport.layout.left, top: viewport.layout.top, width: viewport.layout.width, height: viewport.layout.height }}>
            ...
            {asset && !asset.missing && <EditorCanvas
              ...
              annotations={visibleAnnotations} labels={labels} tool={tool} selectedId={editor.selection.selected} selectedIds={selectedIds} selectedVertex={editor.selectedVertex} selectionMarquee={null}
              ...
              onPointerDown={selecting ? interactions.selectAtCanvas : drawing.onPointerDown} onPointerMove={selecting ? (() => undefined) : drawing.onPointerMove} onPointerUp={selecting ? (() => undefined) : drawing.onPointerUp} onPointerCancel={selecting ? interactions.cancel : drawing.cancelDraft}
