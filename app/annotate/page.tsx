...
import review from "./premerge-review-visibility.module.css";

export default function AnnotatePage() {
  return <div className={`${styles.routeRoot} ${drawer.routeRoot} ${icons.iconContract} ${headerIcons.headerIcons} ${headerLayout.headerLayout} ${brand.brandContract} ${finalPolish.finalPolish} ${review.reviewContract}`}><CanonicalEditorWorkbench /></div>;
}
